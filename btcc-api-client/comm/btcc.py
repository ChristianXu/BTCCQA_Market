...
class BTCC():
    def __init__(self, access=None, secret=None):
        ...
        self.conn = http.client.HTTPSConnection("api-staging.btcc.com")
    ...
    def _get_params_hash(self,pdict):
        ...
        phash = hmac.new(secret_key_bytes, pstring.encode("utf-8"), hashlib.sha1).hexdigest()
    ...
    def _private_request(self,post_data):
        ...
        # must use b64 encode        
        auth_string='Basic '.encode('utf-8')+base64.b64encode((self.access_key+':').encode('utf-8')+pd_hash.encode('utf-8'))
    ...
    def get_account_info(self,post_data={}):
        post_data['method']='getForwardsAccountInfo'
        post_data['params']=[]
